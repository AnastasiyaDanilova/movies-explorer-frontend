    ...
    <section className='portfolio'>
      ...
      <ul className='portfolio__container'>
        <li className='portfolio__link-li'>
          <a className='link portfolio__link' href='https://github.com/AnastasiyaDanilova/how-to-learn' target='blank'>
        ...
        <li className='portfolio__link-li'>
          <a className='link portfolio__link' href='https://github.com/AnastasiyaDanilova/russian-travel' target='blank'>
            <p className='portfolio__site'>Адаптивный сайт</p>
            <img className='portfolio__image' src={arrow} alt='стрелка'></img>
          </a>
        </li>

        <li className='link portfolio__link-li'>
